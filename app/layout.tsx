...
export const metadata: Metadata = {
  ...
  description:
    "RHAI / A.L.I.C.E. â€” Sovereign alignment and audit layer for frontier AI. " +
    "Bias-checked inference, anti-data generation, Merkle-sealed audit trail.",
  openGraph: {
    title: "Verum Frontier // A.L.I.C.E. v1.2 — LIVE GATE",
    description: "Sovereign AI wrapper â€” bias checking, Merkle audit trail, model-agnostic.",
